    ...
    <div class="modal-body">
        <div>
            ...
            <p id="forgetEmailLinkInfo" style="display: none" hidden="true">
                ...
                обычно письмо приходит в течение нескольких секунд. Если же в течении 30 минут вам ничего не пришло, то - проверьте папочку спам,
                попробуйте восстановить пароль еще раз, или же напишите нам на <a href="mailto:info@cheatfood.com">info@cheatfood.com</a>
            </p>
